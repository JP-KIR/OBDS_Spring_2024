...
#SBATCH --output=/project/bras2854/1_linux/rnaseq/mapped_reads/%j_%x.out
#SBATCH --error=/project/bras2854/1_linux/rnaseq/mapped_reads/%j_%x.err
...
samtools view -@ 12 -h -b /project/bras2854/1_linux/rnaseq/mapped_reads/ERR1755082.sam > /project/bras2854/1_linux/rnaseq/mapped_reads/ERR1755082.bam
samtools sort -@ 12 /project/bras2854/1_linux/rnaseq/mapped_reads/ERR1755082.bam > /project/bras2854/1_linux/rnaseq/mapped_reads/sorted.bam
samtools index -@ 12 /project/bras2854/1_linux/rnaseq/mapped_reads/sorted.bam 

...
samtools idxstats /project/bras2854/1_linux/rnaseq/mapped_reads/sorted.bam > /project/bras2854/1_linux/rnaseq/mapped_reads/sorted.idxstats
samtools flagstat /project/bras2854/1_linux/rnaseq/mapped_reads/sorted.bam > /project/bras2854/1_linux/rnaseq/mapped_reads/sorted.flagstat
